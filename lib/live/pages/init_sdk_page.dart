...
import 'package:mall/live/ui/zego_ui_tool.dart';
...
class _InitPageState extends State<InitPage> {
  final TextEditingController _appIDEdController =
      new TextEditingController(text: '1375578980');
  final TextEditingController _appSignEdController = new TextEditingController(
      text: '2ddd5fd2be0ee086d03bb0bea2b38c9ae182e9b2c202cd724cbabf9f7fe60be5');
  ...
  void onButtonPressed() {
    ...
    ZegoExpressEngine.createEngine(
        appID, appSign, isTestEnv, ZegoScenario.values[scenario],
              ...
              Row(
                children: <Widget>[
                  ...
                  GestureDetector(
                    ...
                    onTap: () {
                      ZegoUITool.showAlert(
                          context, 'AppID和AppSign 是每个客户的唯一标识符， 请申请');
                    },
                  ),
                ],
              ),
